$(document).ready(function(){
	...
	$('body').on('click', '#popup_upvote', function(){

		$(this).stop();
		var post_id = $(this).parent().find('#popup_post_id').val();
		var user = $(this).parent().find('#popup_user').val();
		var post_type = $(this).parent().find('#popup_post_type').val();
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data != 'Already upvoted.'){
					...
					myThis.hide();
					myThis.parent().find('#popup_upvoted').show();
					counter++;
					...
					myThis.hide();
					myThis.parent().find('#popup_upvoted').show().fadeOut(1500);
	...
	$('body').on('click', '#popup_upvoted', function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data != 'Have not upvoted.'){
					...
					myThis.hide();
					myThis.parent().find('#popup_upvote').show();
					counter--;
					up_count.html(counter);
	...
	$('body').on('click', '#popup_downvote', function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data != 'Already downvoted.'){
					...
					myThis.hide();
					myThis.parent().find('#popup_downvoted').show();
					counter++;
	...
	$('body').on('click', '#popup_downvoted', function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data != 'Have not downvoted.'){
					...
					myThis.hide();
					myThis.parent().find('#popup_downvote').show();
					counter--;
					down_count.html(counter);
	...
	$('body').on('click', '#popup_share', function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data != 'Already shared.'){
					...
					myThis.hide();
					myThis.parent().find('#popup_shared').show();
					counter++;
	...
	$('body').on('click', '#popup_shared', function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data != 'Have not shared.'){
					...
					myThis.hide();
					myThis.parent().find('#popup_share').show();
					counter--;
					share_count.html(counter);
	...
	$('body').on('click', '#popup_varify', function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data != 'Already verified.'){
					...
					myThis.hide();
					myThis.parent().find('#popup_varified').show();
					counter++;
	...
	$('body').on('click', '#popup_varified', function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data != 'Have not verified.'){
					...
					myThis.hide();
					myThis.parent().find('#popup_varify').show();
					counter--;
					varify_count.html(counter);
	...
	$('body').on('click', '#popup_report', function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data != 'Already reported.'){
					...
					myThis.hide();
					myThis.parent().find('#popup_reported').show();
	...
	$('body').on('click', '#popup_reported', function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data != 'Have not reported.'){
					...
					myThis.hide();
					myThis.parent().find('#popup_report').show();
	...
	$('body').on('click', '#popup_comment', function(){

		$(this).parent().find('#popup_comment_here').slideDown(500);

	});

	$('body').on('submit', '#popup_comment_form', function(e){
		$(this).stop();
		e.preventDefault();
		var comment_box = $(this).find('#popup_comment_text');
	...
	$('body').on('click', '#popup_show_comments', function(){

		$(this).stop();
		var parent = $(this).parent().parent().parent();
		var post_id = parent.find('#popup_post_id').val();
		var user = parent.find('#popup_user').val();
		var post_type = parent.find('#popup_post_type').val();
