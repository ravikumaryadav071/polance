...
(2, 'rahul', 'rahul', '8325e5f13fffeb8a5a1c2b768e74291d33f874e84f8ef695975abff3b42bd5f9', '°¶˜•9¹swá„ãš*)|¬¶½Ð>|ßmƒp—ez', 'rahul', '4512365478', 'images/profile_pic/Uncharted_2_Among_Thieves_1680x1050widescreen.jpg_rahul.jpg0fca9dc8691bf1285214f8c80e5a840632f20454202e90b92a9596d1a9613ced_rahul.jpg', 'images/profile_pic_dg/Uncharted_2_Among_Thieves_1680x1050widescreen.jpg_rahul.jpg0fca9dc8691bf1285214f8c80e5a840632f20454202e90b92a9596d1a9613ced_rahul.jpg', '2015-09-08 02:39:30', 1),
...
(4, 'anil', 'anil', 'd753e4417a8ab7092de6a6a78097e08980a3391986c1b21e2d736a733a440141', '¤åŸô$ËñËÈ’à‘QÁ¾^È,õîT¦Žw²U¦ü', 'anil', '89746362115', 'images/profile_pic/0c3831d5241437160b5bb694863a7edf677a4c27d51324bda2ae8107350b3b5f_anil.jpg', 'images/profile_pic_dg/0c3831d5241437160b5bb694863a7edf677a4c27d51324bda2ae8107350b3b5f_anil.jpg', '2015-09-08 02:40:40', 1);

-- --------------------------------------------------------

--
-- Table structure for table `users_last_updated`
--

CREATE TABLE IF NOT EXISTS `users_last_updated` (
  `userid` int(11) NOT NULL,
  `last_friend_id` int(11) NOT NULL,
  `last_follower_id` int(11) NOT NULL,
  `last_friend_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `last_follower_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `users_last_updated`
--

INSERT INTO `users_last_updated` (`userid`, `last_friend_id`, `last_follower_id`, `last_friend_time`, `last_follower_time`) VALUES
(1, 139, 139, '2015-09-14 19:40:58', '2015-09-14 19:40:58'),
(2, 20, 20, '2015-09-13 14:13:28', '2015-09-13 14:13:28'),
(3, 0, 0, '2015-09-13 10:09:50', '2015-09-13 10:09:50'),
(4, 0, 0, '2015-09-13 10:10:16', '2015-09-13 10:10:16');
...
--
-- Indexes for table `users_last_updated`
--
ALTER TABLE `users_last_updated`
  ADD PRIMARY KEY (`userid`);
