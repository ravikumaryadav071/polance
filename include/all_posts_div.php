...
if(isset($post_info)){
	...
	$db_upr->get("{$p_user_data->username}_{$post->post_id}_upvotes", array('userid', '=', $user_data->id));
	$upvoted = $db_upr->count();

	$db_upr->get("{$p_user_data->username}_{$post->post_id}_downvotes", array('userid', '=', $user_data->id));
	$downvoted = $db_upr->count();

	$db_upr->get("{$p_user_data->username}_{$post->post_id}_shares", array('userid', '=', $user_data->id));
	$shared = $db_upr->count();

	$db_upr->get("{$p_user_data->username}_{$post->post_id}_reports", array('userid', '=', $user_data->id));
	$reported = $db_upr->count();

	$db_upr->get("{$p_user_data->username}_{$post->post_id}_varify", array('userid', '=', $user_data->id));
	...
	<div class="checkborder" <?php if(isset($stv)){ ?>id="<?php echo $stv; ?>"<?php } ?>>
		...
		<div id="user_response">
			...
			if($can_edit){
				?>
				<a href="edit_users_posts.php?user=<?php echo $p_user_data->id; ?>&post=<?php echo $post->post_id; ?>">Edit</a>
				<?php
			}
			?>
			...
			<div id="comment_here" hidden="hidden">
				...
				<form id="comment_form" method="post" action="">
					...
					<input type="hidden" name="post_id" id="c_post_id" value="<?php echo $post->post_id; ?>">
					<input type="hidden" name="user" id="c_user" value="<?php echo $p_user_data->id; ?>">
					<input type="hidden" name="post_type" id="c_post_type" value="<?php echo $post->post_type; ?>">
