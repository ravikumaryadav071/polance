...
class DBusers_feeds{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_users_feeds/host') .';dbname=' . config::get('mysql_for_users_feeds/db'), config::get('mysql_for_users_feeds/username'), config::get('mysql_for_users_feeds/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBusers_feeds();
		}
