<?php
class DBinterests_corporate_world{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_interests_corporate_world/host') .';dbname=' . config::get('mysql_for_interests_corporate_world/db'), config::get('mysql_for_interests_corporate_world/username'), config::get('mysql_for_interests_corporate_world/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBinterests_corporate_world();
		}
