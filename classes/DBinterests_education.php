...
class DBinterests_education{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_interests_education/host') .';dbname=' . config::get('mysql_for_interests_education/db'), config::get('mysql_for_interests_education/username'), config::get('mysql_for_interests_education/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBinterests_education();
		}
