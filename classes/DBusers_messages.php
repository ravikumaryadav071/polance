...
class DBusers_messages{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_users_messages/host') .';dbname=' . config::get('mysql_for_users_messages/db'), config::get('mysql_for_users_messages/username'), config::get('mysql_for_users_messages/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBusers_messages();
		}
