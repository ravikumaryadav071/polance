...
class DBcollaborations_posts{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_collaborations_posts/host') .';dbname=' . config::get('mysql_for_collaborations_posts/db'), config::get('mysql_for_collaborations_posts/username'), config::get('mysql_for_collaborations_posts/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBcollaborations_posts();
		}
