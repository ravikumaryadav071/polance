...
class DBusers_posts_comments{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_users_posts_comments/host') .';dbname=' . config::get('mysql_for_users_posts_comments/db'), config::get('mysql_for_users_posts_comments/username'), config::get('mysql_for_users_posts_comments/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBusers_posts_comments();
		}
