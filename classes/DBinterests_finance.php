...
class DBinterests_finance{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_interests_finance/host') .';dbname=' . config::get('mysql_for_interests_finance/db'), config::get('mysql_for_interests_finance/username'), config::get('mysql_for_interests_finance/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBinterests_finance();
		}
