...
class DBusers_collections{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_users_collections/host') .';dbname=' . config::get('mysql_for_users_collections/db'), config::get('mysql_for_users_collections/username'), config::get('mysql_for_users_collections/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBusers_collections();
		}
