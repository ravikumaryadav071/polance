...
class DBusers_connection{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_users_connection/host') .';dbname=' . config::get('mysql_for_users_connection/db'), config::get('mysql_for_users_connection/username'), config::get('mysql_for_users_connection/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBusers_connection();
		}
