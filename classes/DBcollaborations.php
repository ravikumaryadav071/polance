...
class DBcollaborations{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_collaborations/host') .';dbname=' . config::get('mysql_for_collaborations/db'), config::get('mysql_for_collaborations/username'), config::get('mysql_for_collaborations/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBcollaborations();
		}
