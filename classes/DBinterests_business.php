...
class DBinterests_business{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_interests_business/host') .';dbname=' . config::get('mysql_for_interests_business/db'), config::get('mysql_for_interests_business/username'), config::get('mysql_for_interests_business/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBinterests_business();
		}
