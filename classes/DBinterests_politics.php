...
class DBinterests_politics{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_interests_politics/host') .';dbname=' . config::get('mysql_for_interests_politics/db'), config::get('mysql_for_interests_politics/username'), config::get('mysql_for_interests_politics/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBinterests_politics();
		}
