...
class DBinterests_social{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_interests_social/host') .';dbname=' . config::get('mysql_for_interests_social/db'), config::get('mysql_for_interests_social/username'), config::get('mysql_for_interests_social/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBinterests_social();
		}
