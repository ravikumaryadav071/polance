...
class DBinterests_philosophy{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_interests_philosophy/host') .';dbname=' . config::get('mysql_for_interests_philosophy/db'), config::get('mysql_for_interests_philosophy/username'), config::get('mysql_for_interests_philosophy/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBinterests_philosophy();
		}
