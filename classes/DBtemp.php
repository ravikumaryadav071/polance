...
class DBtemp{
	...
	public function __construct($database){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get("mysql_for_{$database}/host") .';dbname=' . config::get("mysql_for_{$database}/db"), config::get("mysql_for_{$database}/username"), config::get("mysql_for_{$database}/password"));
	...
	// 	if($_prevDb != $database){
	// 		self::$_instance = new DBtemp($database);
	// 	}
