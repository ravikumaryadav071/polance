...
class DBusers_notifications{
	...
	private function __construct(){
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_users_notifications/host') .';dbname=' . config::get('mysql_for_users_notifications/db'), config::get('mysql_for_users_notifications/username'), config::get('mysql_for_users_notifications/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBusers_notifications();
		}
