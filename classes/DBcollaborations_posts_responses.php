<?php
class DBcollaborations_posts_responses{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_collaborations_posts_responses/host') .';dbname=' . config::get('mysql_for_collaborations_posts_responses/db'), config::get('mysql_for_collaborations_posts_responses/username'), config::get('mysql_for_collaborations_posts_responses/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBcollaborations_posts_responses();
		}
