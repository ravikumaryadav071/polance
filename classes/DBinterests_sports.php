...
class DBinterests_sports{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_interests_sports/host') .';dbname=' . config::get('mysql_for_interests_sports/db'), config::get('mysql_for_interests_sports/username'), config::get('mysql_for_interests_sports/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBinterests_sports();
		}
