<?php
class DBcollaborations_members{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_collaborations_members/host') .';dbname=' . config::get('mysql_for_collaborations_members/db'), config::get('mysql_for_collaborations_members/username'), config::get('mysql_for_collaborations_members/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBcollaborations_members();
		}
