...
class DBpolance_data{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_polance_data/host') .';dbname=' . config::get('mysql_for_polance_data/db'), config::get('mysql_for_polance_data/username'), config::get('mysql_for_polance_data/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBpolance_data();
		}
