<?php
class DBcollaborations_comments{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_collaborations_comments/host') .';dbname=' . config::get('mysql_for_collaborations_comments/db'), config::get('mysql_for_collaborations_comments/username'), config::get('mysql_for_collaborations_comments/password'));
	...
	public static function getInstance(){
		...
		if(!isset(self::$_instance)){
			self::$_instance = new DBcollaborations_comments();
		}
